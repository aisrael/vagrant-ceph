...
sudo apt-get update
sudo apt-get install -y expect ceph-deploy
...
ceph-deploy osd prepare node2:/var/ceph/osd0 node3:/var/ceph/osd1
ceph-deploy osd activate node2:/var/ceph/osd0 node3:/var/ceph/osd1
